...
class BuscarTodosFuncionariosAdapterTest {

    private BuscarTodosFuncionariosAdapter buscarTodosFuncionariosAdapter;
    ...
    void setUp() {
        ...
        buscarTodosFuncionariosAdapter = new BuscarTodosFuncionariosAdapter(funcionarioRepository, funcionarioEntityToFuncionarioMapper);
    }

    @Test
    void buscarTodos_DeveRetornarListaDeFuncionariosQuandoExistiremRegistros() {
        // Arrange
        ...
        // Act
        List<Funcionario> resultado = buscarTodosFuncionariosAdapter.buscarTodos();
    ...
    @Test
    void buscarTodos_DeveRetornarListaVaziaQuandoNaoHouverRegistros() {
        // Arrange
        List<FuncionarioEntity> funcionarioEntityList = Arrays.asList();

        List<Funcionario> funcionarioList = Arrays.asList();
